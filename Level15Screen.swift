...
struct Level15Screen: View {
    ...
    @State var Voffset: [CGSize] = [.zero,.zero,.zero]
    @State var Hoffset: [CGSize] = [.zero,.zero,.zero,.zero]
    ...
    @State var VPosition: [[CGFloat]] = [[lv3w*2,lv3w],[-lv3w*2,-lv3w],[0,-lv3w]]
    @State var HPosition: [[CGFloat]] = [[lv3w,lv3w*2],[-lv3w,0],[lv3w,0],[-lv3w,-lv3w*2]]
    
    @State var VpositionIdx: [Int] = [2, 3, 4]
    @State var HpositionIdx: [Int] = [1, 2, 3, 4]
    
    @State var Vstate: [Bool] = [false, false, true, true, true, false]
    @State var Hstate: [Bool] = [false, true, true, true, true, false]
    
    @State var correctVstate1: [Bool] = [true, true, true, false, false, false]
    @State var correctHstate1: [Bool] = [true, false, false, true, true, true]
    
    @State var correctVstate2: [Bool] = [false, false, false, true, true, true]
    @State var correctHstate2: [Bool] = [true, true, true, false, false, true]
